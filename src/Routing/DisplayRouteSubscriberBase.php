...
abstract class DisplayRouteSubscriberBase extends RouteSubscriberBase {
   ...
   *
   * @see \Drupal\ctools\Routing\Enhancer\DisplayRouteEnhancer
   */
  ...
  protected function addDisplayRoutes(RouteCollection $collection, $path) {
    ...
    $route = new Route(
      ...
      [
        ...
        '_title_callback' => '\Drupal\ctools\Controller\DisplayController::editDisplayTitle',
      ] + $defaults,
    ...
    $route = new Route(
      ...
      [
        '_controller' => '\Drupal\ctools\Controller\DisplayController::performDisplayOperation',
        'op' => 'enable',
      ] + $defaults,
      ['_entity_access' => "{$entity_type_id}.update"],
      $options
  ...
  protected function addAccessRoutes(RouteCollection $collection, $path) {
    ...
    $route = new Route(
      "{$path}/select",
      [
        '_controller' => '\Drupal\ctools\Controller\DisplayController::selectAccessCondition',
    ...
    $route = new Route(
      ...
      [
        ...
        '_title_callback' => '\Drupal\ctools\Controller\DisplayController::editAccessConditionTitle',
      ] + $defaults,
      $requirements,
      $options
    );
  ...
  protected function addParameterRoutes(RouteCollection $collection, $path) {
    ...
    $route = new Route(
      "{$path}/add",
      [
        '_form' => '\Drupal\ctools\Form\ParameterAddForm',
    ...
    $route = new Route(
      "{$path}/edit/{name}",
      [
        '_form' => '\Drupal\ctools\Form\ParameterEditForm',
        '_title_callback' => '\Drupal\ctools\Controller\DisplayController::editParameterTitle',
      ] + $defaults,
      $requirements,
      $options
    );
    ...
    $route = new Route(
      "{$path}/delete/{name}",
      [
        '_form' => '\Drupal\ctools\Form\ParameterDeleteForm',
  ...
  protected function addVariantRoutes(RouteCollection $collection, $path) {
    ...
    $route = new Route(
      "{$path}/add",
      [
        '_controller' => '\Drupal\ctools\Controller\DisplayController::selectVariant',
    ...
    $route = new Route(
      ...
      [
        '_controller' => '\Drupal\ctools\Controller\DisplayController::addDisplayVariantEntityForm',
        '_title' => 'Add variant',
      ] + $defaults,
      ['_entity_access' => "{$entity_type_id}.update"],
      $options
    ...
    $route = new Route(
      ...
      [
        ...
        '_title_callback' => '\Drupal\ctools\Controller\DisplayController::editDisplayVariantTitle',
      ] + $defaults,
      $requirements,
      $options
    );
    ...
    $route = new Route(
      ...
      [
        '_controller' => '\Drupal\ctools\Controller\DisplayController::selectBlock',
        '_title' => 'Seelct block',
      ] + $defaults,
      $requirements
    );
  ...
  protected function addStaticContextRoutes(RouteCollection $collection, $path) {
    ...
    $route = new Route(
      "{$path}/edit/{name}",
      [
        '_form' => '\Drupal\ctools\Form\StaticContextEditForm',
        '_title_callback' => '\Drupal\ctools\Controller\DisplayController::editStaticContextTitle',
      ] + $defaults,
      $requirements
    );
  ...
  protected function addSelectionConditionRoutes(RouteCollection $collection, $path) {
    ...
    $route = new Route(
      "{$path}/select",
      [
        '_controller' => '\Drupal\ctools\Controller\DisplayController::selectSelectionCondition',
    ...
    $route = new Route(
      ...
      [
        ...
        '_title_callback' => '\Drupal\ctools\Controller\DisplayController::editSelectionConditionTitle',
      ] + $defaults,
      $requirements
    );
